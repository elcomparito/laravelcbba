            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/admin-home')); ?>" class="text-sm text-gray-700 underline">Home</a>
                    <?php else: ?>
...
<?php /**PATH C:\laragon\www\telepractica-vue\resources\views/welcome.blade.php ENDPATH**/ ?>